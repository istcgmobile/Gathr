...
public class DatePickerDialog extends DialogFragment implements
    ...
    public static DatePickerDialog newInstance(OnDateSetListener callBack, int year,
            int monthOfYear, 
            int dayOfMonth, boolean showHeader) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth, showHeader);
        return ret;
    }

    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth, boolean showHeader) {
        mCallBack = callBack;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view;
        if(!mShowHeader){
            view = inflater.inflate(R.layout.mdtp_date_picker_calendar, container, false);
        }
        else{
            view = inflater.inflate(R.layout.mdtp_date_picker_dialog, container, false);
        ...
        if(mShowHeader) view.findViewById(R.id.day_picker_selected_date_layout).setBackgroundColor(mAccentColor);
    ...
    private void setCurrentView(final int viewIndex) {
        ...
        switch (viewIndex) {
            case MONTH_AND_DAY_VIEW:
                ...
                if (mCurrentView != viewIndex && mShowHeader) {
    ...
    public void showChosenDate(Boolean yes) {
        LinearLayout pickerHeaderLayout = (LinearLayout) this.getView().findViewById(R.id.day_picker_selected_date_layout);
        if(yes){
            pickerHeaderLayout.setVisibility(View.GONE);
        }
        if(!yes){
            pickerHeaderLayout.setVisibility(View.VISIBLE);
